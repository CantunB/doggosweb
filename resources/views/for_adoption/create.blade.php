...
<div class="container">
    <div class="Back">
     ...
     <form action="{{ route('dar_adopcion.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <input class="btn btn-primary btn-block" type="submit" value="Subir para adopcion"/>
        </div>
    </form>
</div>
@endsection
